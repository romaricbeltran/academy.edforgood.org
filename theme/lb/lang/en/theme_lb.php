...
$string['pluginname'] = 'lb';
$string['configtitle'] = 'lb';
$string['choosereadme'] = 'Learning Booster is a modern highly-customisable theme. This theme is intended to be used directly, or as a parent theme when creating new themes utilising Bootstrap 4.';
...
$string['privacy:metadata:preference:themelbsettings_fonttype'] = 'The user\'s preference for font type.';
$string['privacy:metadata:preference:themelbsettings_enableaccessibilitytoolbar'] = 'The user\'s preference for enable the accessibility toolbar.';
...
$string['privacy:themelbsettings_fonttype'] = 'The current preference for the font type is: {$a}.';
$string['privacy:themelbsettings_enableaccessibilitytoolbar'] = 'The current preference for enable accessibility toolbar is to show it.';
