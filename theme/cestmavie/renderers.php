...
class theme_cestmavie_core_renderer extends theme_boost\output\core_renderer {
    ...
    public function render_login(\core_auth\output\login $form) {
        ...
        # CestMAvie! code start - Render custom loginform
        return $this->render_from_template('theme_cestmavie/loginform', $context);
        # CestMAvie! code end
    }
    ...
    public function block(block_contents $bc, $region) {
        ...
        # CestMAvie! code start - Block my-overview could only be on main page (where we don't want block-bg)
        if ($context->type == "myoverview") {
            $context->isMainPage = true;
        }

        return $this->render_from_template('theme_cestmavie/block', $context);
    }
    ...
    */
    protected function render_context_header(\context_header $contextheader) {
        ...
        # CestMAvie! code start - Add description below title on category page
...
class theme_cestmavie_core_course_renderer extends core_course_renderer {
    ...
    protected function course_name(coursecat_helper $chelper, core_course_list_element $course): string {
        $content = '';
        # CestMAvie! code start - On category page coursename = div style (not h3 style)
    ...
    public function course_category($category) {
        ...
        if (empty($category)) {
            # CestMAvie! code start - Redirect if it's empty 
        ...
        # CestMAvie! code start - Hide description below content filter on category page
