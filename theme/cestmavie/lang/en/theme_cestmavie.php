...
$string['pluginname'] = 'cestmavie';
$string['configtitle'] = 'cestmavie';
$string['choosereadme'] = 'C\'est MA vie! is a modern highly-customisable theme. This theme is intended to be used directly, or as a parent theme when creating new themes utilising Bootstrap 4.';
...
$string['background-color'] = 'Background colour';
$string['background-color_desc'] = 'The background colour.';
$string['background-header-color'] = 'Background Header colour';
$string['background-header-color_desc'] = 'The background header colour.';
$string['block-background-color'] = 'Blocks background colour';
$string['block-background-color_desc'] = 'The blocks background colour.';
$string['button-color'] = 'Buttons colour';
$string['button-color_desc'] = 'The buttons colour.';
$string['link-color'] = 'Links colour';
$string['link-color_desc'] = 'The links colour.';
$string['main-title-color'] = 'Main title colour';
$string['main-title-color_desc'] = 'The main title colour.';
$string['secondary-title-color'] = 'Secondary title colour';
$string['secondary-title-color_desc'] = 'The secondary title colour.';
...
$string['privacy:metadata:preference:themecestmaviesettings_fonttype'] = 'The user\'s preference for font type.';
$string['privacy:metadata:preference:themecestmaviesettings_enableaccessibilitytoolbar'] = 'The user\'s preference for enable the accessibility toolbar.';
...
$string['privacy:themecestmaviesettings_fonttype'] = 'The current preference for the font type is: {$a}.';
$string['privacy:themecestmaviesettings_enableaccessibilitytoolbar'] = 'The current preference for enable accessibility toolbar is to show it.';
